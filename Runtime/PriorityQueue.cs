    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<(TElement Element, TPriority Priority)>, ICollection
        {
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                if (array.Rank != 1)
                {
                    throw new ArgumentException(ErrorMessage.Argument.RankMultiDimNotSupported, 
                                                nameof(array));
                }

                if (array.GetLowerBound(0) != 0)
                {
                    throw new ArgumentException(ErrorMessage.Argument.NonZeroLowerBound, 
                                                nameof(array));
                }
                ...
                if (index < 0 || index > array.Length)
                {
                    throw new ArgumentOutOfRangeException(nameof(index), 
                                                          index, 
                                                          ErrorMessage.ArgumentOutOfRange.IndexMustBeLessOrEqual);
                }
                ...
                {
                    throw new ArgumentException(ErrorMessage.Argument.IncompatibleArrayType, 
                                                nameof(array));
                }
            }
